...
| `Z8104DAF843F74473C` | **CC 100 -- ALSO "Status2" LED** (4-LED status strip, one hardware register/mutex, not 4 bits) | "Thirty-fifth finding": isolated on/off test, confirmed clean |
| `Z8104EC9663F735F63` | **CC 101 -- ALSO "Status3" LED** | same as above |
| `Z8104F404F3F72FCF8` | **CC 102 -- ALSO "Status4" LED** (rightmost); the 0x09 SurfaceStatus family was separately seen lighting this same slot | same as above |
| `Z8104C81913F751BFA` | **CC 99 -- ALSO "Status1" LED** (leftmost) | cross-reference: already listed above as F-Keys |
